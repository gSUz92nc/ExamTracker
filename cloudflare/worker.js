...
var init__ = __esm({
	'.svelte-kit/output/server/nodes/0.js'() {
		...
		imports = [
			'_app/immutable/nodes/0.CivtKw1b.js',
			'_app/immutable/chunks/ChXZ7zeg.js',
			'_app/immutable/chunks/D__H8HoC.js'
		];
		stylesheets = ['_app/immutable/assets/0.8Il5L8yw.css'];
		fonts = [];
	}
});
...
var init__2 = __esm({
	'.svelte-kit/output/server/nodes/1.js'() {
		...
		imports2 = [
			'_app/immutable/nodes/1.DfjU7Uyu.js',
			'_app/immutable/chunks/ChXZ7zeg.js',
			'_app/immutable/chunks/D__H8HoC.js',
			'_app/immutable/chunks/DzDNe_T1.js',
			'_app/immutable/chunks/CEMnaTRj.js',
			'_app/immutable/chunks/DADdrc6s.js'
		];
		stylesheets2 = [];
		fonts2 = [];
	}
...
function _page($$payload, $$props) {
	...
	filteredPapers.reduce((groups, paper) => {
	...
	$$payload.out += `<div class="terminal-container svelte-16xbny8"><header class="terminal-header svelte-16xbny8"><h1 class="svelte-16xbny8">ExamTracker<span class="cursor svelte-16xbny8">_</span></h1> <p class="subtitle svelte-16xbny8">Track your exam performance, focus on what matters</p></header> <nav class="terminal-nav svelte-16xbny8"><ul class="svelte-16xbny8"><li class="svelte-16xbny8"><button${attr_class('nav-link svelte-16xbny8', void 0, { active: activeTab === 'papers' })}>Papers</button></li> <li class="svelte-16xbny8"><button${attr_class('nav-link svelte-16xbny8', void 0, { active: activeTab === 'performance' })}>Performance</button></li> <li class="svelte-16xbny8"><button${attr_class('nav-link svelte-16xbny8', void 0, { active: activeTab === 'settings' })}>Settings</button></li></ul></nav> <main class="terminal-content svelte-16xbny8">`;
	{
		$$payload.out += '<!--[-->';
		$$payload.out += `<div class="papers-tab svelte-16xbny8">`;
		{
			$$payload.out += '<!--[-->';
			const each_array = ensure_array_like(subjects);
			$$payload.out += `<div class="full-width-selection svelte-16xbny8"><div class="section svelte-16xbny8"><div class="section-title svelte-16xbny8">Choose a subject:</div> <div class="options svelte-16xbny8"><!--[-->`;
			for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
				let subject = each_array[$$index];
				$$payload.out += `<button${attr_class('option svelte-16xbny8', void 0, { selected: selectedSubject === subject.id })}>${escape_html(subject.name)}</button>`;
			}
			$$payload.out += `<!--]--></div></div> `;
			{
				$$payload.out += '<!--[!-->';
	...
	$$payload.out += `<!--]--></main> <footer class="terminal-footer svelte-16xbny8"><p class="svelte-16xbny8">\xA9 ${escape_html(/* @__PURE__ */ new Date().getFullYear())} <a href="https://github.com/gSUz92nc/ExamTracker" target="_blank" rel="noopener noreferrer" title="This link will redirect you to GitHub" class="svelte-16xbny8">Visit ExamTracker on GitHub</a></p></footer></div>`;
	pop();
}
...
var init__3 = __esm({
	'.svelte-kit/output/server/nodes/2.js'() {
		...
		imports3 = [
			'_app/immutable/nodes/2.CgCbmJri.js',
			'_app/immutable/chunks/ChXZ7zeg.js',
			'_app/immutable/chunks/D__H8HoC.js',
			'_app/immutable/chunks/DzDNe_T1.js',
			'_app/immutable/chunks/CQDYwOgg.js'
		];
		stylesheets3 = ['_app/immutable/assets/2.BHHN3hpX.css'];
		fonts3 = [];
	}
});
		...
		value,
		{
			...
			set(target, prop, value2, receiver) {
				...
				if (is_proxied_array && prop === 'length') {
					for (var i = value2; i < /** @type {Source<number>} */ s2.v; i += 1) {
...
var options = {
	...
	templates: {
		app: ({ head: head2, body: body2, assets: assets2, nonce, env }) =>
			'<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' +
			assets2 +
			`/favicon.svg" />
...
function has_prerendered_path(manifest2, pathname) {
	return (
		...
		(pathname.at(-1) === '/' && manifest2._.prerendered_routes.has(pathname.slice(0, -1)))
	);
}
...
function generate_route_object(route, url, manifest2) {
	...
	const nodes = [...errors, ...layouts.map((l) => l?.[1]), leaf[1]]
		...
		.map((n) => `'${n}': () => ${create_client_import(manifest2._.client.nodes?.[n], url)}`)
		.join(',\n		');
	return [
		`{
	id: ${s(route.id)}`,
...
async function render_response({
	...
	if (page_config.ssr && page_config.csr) {
		body2 += `
			${fetched
				.map((item) =>
					serialize_data(item, resolve_opts.filterSerializedResponseHeaders, !!state2.prerendering)
				)
				.join('\n			')}`;
	}
	if (page_config.csr) {
	...
	const server_fetch = async (info, init2) => {
		...
		return options2.hooks.handleFetch({
			...
			fetch: async (info2, init3) => {
				...
				const is_asset_html =
					manifest2.assets.has(filename_html) || filename_html in manifest2._.server_assets;
...
var manifest = (() => {
	...
	return {
		...
		_: {
			client: {
				start: '_app/immutable/entry/start.BUatgiaK.js',
				app: '_app/immutable/entry/app.BbUsoQbx.js',
				imports: [
					'_app/immutable/entry/start.BUatgiaK.js',
					'_app/immutable/chunks/CEMnaTRj.js',
					'_app/immutable/chunks/D__H8HoC.js',
					'_app/immutable/chunks/DADdrc6s.js',
					'_app/immutable/entry/app.BbUsoQbx.js',
					'_app/immutable/chunks/D__H8HoC.js',
					'_app/immutable/chunks/DzDNe_T1.js',
					'_app/immutable/chunks/ChXZ7zeg.js',
					'_app/immutable/chunks/CQDYwOgg.js',
...
async function get_asset_from_kv(
	req,
	env,
	context2,
	map = import_kv_asset_handler.mapRequestToAsset
) {
